...
These are the ones you must master first — they appear in ~80% of interviews and form the foundation.
...
**Target:** 40–60 problems (easy → medium)
...
**Target:** 25–40 problems (easy → medium)
...
**Why:** Frequency counting, lookup, grouping — essential for real problems.
...
**Target:** 30–40 problems (mix fixed-size & variable-size windows)
...
**Why:** Sorting is a pre-step; binary search used in search problems & “search on answer”.
...
## Dynamic Programming (important but conceptually heavier) 
 ...
 start after you’ve done many medium problems. Target core DP: Climbing Stairs, House Robber, Coin Change, Longest Increasing Subsequence. (30–50 problems over time)
...
## Trie, Segment Tree, Binary Indexed Tree, Suffix Array, Rolling Hash, Line Sweep, Advanced Graph Algorithms, Bitmask DP, Combinatorics, etc. — 
